...
pub trait Greeter {
    fn say_hello(&self, o: ::grpc::RequestOptions, p: super::ring::HelloRequest) -> ::grpc::SingleResponse<super::ring::HelloReply>;
}
...
pub struct GreeterClient {
    ...
    method_SayHello: ::std::sync::Arc<::grpc::rt::MethodDescriptor<super::ring::HelloRequest, super::ring::HelloReply>>,
}
